...
# Productivity
cres = spline.correlog(x = div.table$lat, y = div.table$lon, resamp = 100, z = resid(cn.logn))
plot(cres, ylim = c(-1,1), main = "C:N") # No significant spatial autocorrelation is observed using spatial correlograms.

# Productivity
cres = spline.correlog(x = div.table$lat, y = div.table$lon, resamp = 100, z = resid(cp.logn))
plot(cres, ylim = c(-1,1), main = "C:P") # No significant spatial autocorrelation is observed using spatial correlograms.
